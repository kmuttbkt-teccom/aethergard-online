...
export class HeroCompanion3D {
    ...
    isAttacking = false;
    attackAnimT = 0;
    constructor(hero, slotIndex, startPos, scene) {
        this.hero = hero;
     ...
     */
    update(time, dt, playerPos, playerFacingAngle, targetMonster, effects, onDealDamage) {
        ...
        const followTarget = new THREE.Vector3(playerPos.x + worldOffsetX, playerPos.y, playerPos.z + worldOffsetZ);
    ...
    triggerBasicAttack(target, effects, onDealDamage) {
    ...
    triggerSkill(target, effects, onDealDamage) {
        this.isAttacking = true;
