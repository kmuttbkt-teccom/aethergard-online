...
export class ThreeTerrain {
    ...
    createAncientTree(x, z, scale, leafColor) {
    ...
    createGlowingMushroom(x, z, color) {
    ...
    buildGrassTufts() {
        ...
        const createTuft = (gx, gz, hasFlower) => {
    ...
    updateParticles(time) {
        if (!this.particlesGroup)
            return;
        const positions = this.particlesGroup.geometry.attributes.position.array;
