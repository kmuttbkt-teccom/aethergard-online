import { MonsterData } from '../../../server/src/types.js';
...
export class ClientMonster {
  ...
  private renderPoring(ctx: CanvasRenderingContext2D) {
  ...
  private renderFabre(ctx: CanvasRenderingContext2D) {
  ...
  private renderSpore(ctx: CanvasRenderingContext2D) {
  ...
  private renderPecoPeco(ctx: CanvasRenderingContext2D) {
  ...
  private renderBaphometJr(ctx: CanvasRenderingContext2D) {
