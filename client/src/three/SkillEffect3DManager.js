...
export class SkillEffect3DManager {
    ...
    // =========================================================================
    spawnMeteor(target, radius = 3.5, color = 0xff5a1f) {
    ...
    triggerMeteorExplosion(pos, radius, color) {
        const d = new DisposablesTracker();
    ...
    // =========================================================================
    spawnRadiantSword(center, radius = 3.0) {
        const d = new DisposablesTracker();
        const group = new THREE.Group();
    ...
    triggerRadiantImpact(center, radius) {
        const d = new DisposablesTracker();
        const group = new THREE.Group();
    ...
    // =========================================================================
    spawnFrostNova(center, radius = 3.5) {
        const d = new DisposablesTracker();
        const group = new THREE.Group();
        group.position.set(center.x, 0, center.z);
        this.scene.add(group);
    ...
    // =========================================================================
    spawnGaleArrow(origin, target, onHit) {
        const d = new DisposablesTracker();
        const group = new THREE.Group();
    ...
    // =========================================================================
    playSkill(skillId, casterPos, rotY, targetPos, centerPos) {
        switch (skillId) {
            case 'ASTRAL_METEOR':
