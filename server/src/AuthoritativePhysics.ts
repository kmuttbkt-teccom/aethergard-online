...
export class AuthoritativePhysics {
  public static readonly MAP_WIDTH = 14400;
  public static readonly MAP_HEIGHT = 720;
  public static readonly GRAVITY = 980;
  public static readonly MAX_FALL_SPEED = 650;
  public static readonly BASE_MOVE_SPEED = 210;

  public static readonly PLATFORMS: ServerPlatform[] = [
   ...
   */
  public static step(
    player: { x: number; y: number; vx: number; vy: number; isGrounded: boolean; facing: 'left' | 'right'; anim: 'idle' | 'walk' | 'jump' | 'attack' | 'dead'; stats: { agi: number }; speedMultiplier?: number },
    input: { left: boolean; right: boolean; up: boolean; down: boolean; jump: boolean },
    dt: number
  ): { x: number; y: number; vx: number; vy: number; isGrounded: boolean; facing: 'left' | 'right'; anim: 'idle' | 'walk' | 'jump' | 'attack' | 'dead' } {
    ...
    if (player.vy > this.MAX_FALL_SPEED) player.vy = this.MAX_FALL_SPEED;
