...
export class ModelAssetManager {
     ...
     */
    async loadModel(urlOrId, customHeight) {
        ...
        if (urlOrId.startsWith('weapon_')) {
            ...
            switch (urlOrId) {
                ...
                case 'weapon_dagger':
                    ...
                    break;
                case 'weapon_shield':
                    visual = Weapon3DBuilder.createAegisShield();
                    break;
                default:
                    visual = Weapon3DBuilder.createExcalibur();
                    break;
     ...
     */
    _normalizeGLTF(gltf, targetHeight) {
            ...
            if (child.isMesh) {
                ...
                if (m.material) {
                    ...
                    if (mat.roughness !== undefined)
                        mat.roughness = Math.min(0.85, mat.roughness);
                }
            }
        });
     ...
     */
    registerCustomModel(name, url, category, height = 1.85) {
